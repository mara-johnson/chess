...
// Piece Name: Knight
// Description: This class defines a regular Knight chess piece. It includes
//attributes such as color and position. It also has methods for moving and legal
//moves.
...
// Postcondition: Returns a list of valid squares the knight can control within
//board boundaries.
...
if(b.getTurn() && start.getOccupyingPiece().getColor())
...
targetSquare.getOccupyingPiece().getColor() != this.color) {
