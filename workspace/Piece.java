...
public class Piece {
    ...
    //returns a list of every square that is "controlled" by this piece. 
    ...
    //Returns a list of all allowed moves for a pawn, including normal movement and possible captures
    ...
    //with the option to move one or two squares on their first tunr. They can capture diagonally.
